...
class PDF(FPDF):
    ...
    def create_table(self, table_data, title='', subtitle='', data_size = 10, title_size=12, align_data='L', align_header='L', cell_width='even', x_start='x_default',emphasize_data=[], emphasize_style=None,emphasize_color=(0,0,0)): 
        """
        table_data: 
        ...
        if title != '':
            ...
            self.multi_cell(0, line_height, subtitle, border=0, align='c', ln=3, max_line_height=self.font_size)
            self.ln(line_height)
